...
<div class="container">
		...
		{!! Form::model($products, ['route' => ['juice.update', $products->id], 'method' => 'put']) !!}
		@else
		{!! Form::open(['route' => ['juice.store'], 'method' => 'POST']) !!}
		@endif
	...
	@if(Auth::user() && Auth::user()->isAdmin())
		...
		{!! Form::open(['route'=> ['juice.destroy', $products->id], 'method' => 'DELETE']) !!}
