...
<head>
    ...
    <link href="{{ asset('css/pad.css') }}" rel="stylesheet">   
...
<body>
    <header id="back_image">
            <div id="vertical_text">
                <h3>UAB Inroma - trinkelių klojimas!</h3>
            </div>
            <div id="vertical_text2">
                <h3>Tel. +37065500446</h3>
            </div>
    </header>
    ...
    <div id="app" class="borders">
        <nav>
            <div class="container">
                  ...
                  <!--   </a> -->
                    <nav class="mainnavigation">
                        <ul class="nav nav-pills">
                            ...
                            <li><a href="/aboutfour">Apie mus</a></li>
                            <li><a id="demo" href="/bricketts">Siūlomos paslaugos</a></li>
                            @if(Auth::user() && Auth::user()->isAdmin())
                            <li><a href="/orders">Klausimai</a></li>
                            @endif
                            <li><a href="/contactsfour">Kontaktai</a></li>
                        </ul>
                    </nav>
                </div>
                ...
                <div>
                    @if(Auth::user() && Auth::user()->isAdmin())
                        <a href="{{ route('bricketts.create') }}" class="btn btn-success">Sukurti naują paslaugą</a>
