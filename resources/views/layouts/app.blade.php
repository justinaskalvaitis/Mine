...
<body>
    <header id="back_image">
            <div id="vertical_text">
                <h3>UAB Inroma - Mums rūpi jūsų jaukumas!</h3>
            </div>
    ...
    <div id="app" class="borders">
        <nav>
            <div class="container">
                  ...
                  <!--   </a> -->
                    <nav class="mainnavigation">
                        <ul class="nav nav-pills">
                            ...
                            <li><a id="demo" href="/products">Kietas kuras</a></li>
                ...
                <div>
                    @if(Auth::user() && Auth::user()->isAdmin())
                        <a href="{{ route('products.create') }}" class="btn btn-success">Naujas kieto kuro produktas</a>
