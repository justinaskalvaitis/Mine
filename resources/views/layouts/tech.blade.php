...
<body>
    <header id="back_image">
            <div id="vertical_text">
                <h3>UAB Inroma - statybinės technikos nuoma!</h3>
            </div>
            <div id="vertical_text2">
                <h3>Tel. +37065511401</h3>
            </div>
    </header>
    ...
    <div id="app" class="borders">
        <nav>
            <div class="container">
                  ...
                  <!--   </a> -->
                    <nav class="mainnavigation">
                        <ul class="nav nav-pills">
                            ...
                            <li><a href="/abouttwo">Apie mus</a></li>
                            <li><a id="demo" href="/tech">Mūsų technika</a></li>
                            @if(Auth::user() && Auth::user()->isAdmin())
                            <li><a href="/orders">Klausimai</a></li>
                            @endif
                            <li><a href="/contactstwo">Kontaktai</a></li>
                        </ul>
                    </nav>
                </div>
                ...
                <div>
                    @if(Auth::user() && Auth::user()->isAdmin())
                        <a href="{{ route('tech.create') }}" class="btn btn-success">Naujas technikos produktas</a>
